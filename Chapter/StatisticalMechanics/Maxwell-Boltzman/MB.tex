...
\begin{equation*}
    n(\epsilon)\;d\epsilon=\frac{2\pi N}{(\pi kT)^{3/2}}\sqrt{\epsilon}\exp\left(-\frac{\epsilon}{k_BT}\right)\;d\epsilon
\end{equation*}
...
\begin{figure*}
    \centering
    \normfigL{../Rss/StatisticalMechanics/Maxwell-Boltzman/0jklyest5w.png}
